...
namespace Readymade.Databinding.Components {
    ...
    [AddComponentMenu ( "Databinding/" + nameof ( InputIntegerVariableBinding ) )]
    public class InputIntegerVariableBinding : ComponentBinding<int, IntegerVariable, TMP_InputField, string> {
        /// <inheritdoc />
